...
import pypyodbc
import time
# from colorama import init, Fore, Back, Style  # 实测生成exe不能使用。
from termcolor import colored   # 实测生成exe不能使用。
